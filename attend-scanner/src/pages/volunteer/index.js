...
const API_URL = "ingenius2024.anuragrao.me:5001";
var qr;
...
export default function Home() {
   ...
   const presentCall = () => {
      ...
      axios
         ...
         .catch((err) => {
            console.log(err);
            alert("Something is wrong with backend, contact Anurag/Achyuth ASAP!");
         });
   };
         ...
         <main className={styles.main2}>
            {details ? (
               <>
                  ...
                  />
                  <button onClick={dismissQrReader} className="btn btn-primary ">
                     Toggle Scanner
                  </button>
                  <h1
                     style={{
               ...
               <div>
                  <center>
                     ...
                     {data1.present ? (
                        <h5>
                           Entry time : {data1.entry_time.slice(11, -10)}{" "}
                           {data1.entry_time.slice(0, 10)}
                        </h5>
                     ) : null}
                     ...
                     {data1.checkout ? (
                        <h5>
                           Exit time : {data1.exit_time.slice(11, -10)}{" "}
                           {data1.exit_time.slice(0, 10)}
                        </h5>
                     ) : null}
                     <div>
                        ...
                        <div className="container">
                           ...
                           <div className="row">
                              ...
                              <div className="col p-3">
                                 <button
                                    id="Breakfast1"
                                    disabled={data1.meals.breakfast1}
                                    className="btn btn-primary "
                                    type="button"
                                    onClick={handleFood}
                                 >
