...
export const Countdown = ({targetTime}) => {
  ...
  return (
    ...
    >
      <div className={`flex flex-col items-center justify-center font mono lg:text-7xl text-3xl text-[#fac518] font-bold`}>
       <h1 className="mb-4 ">TIME UNTIL FINAL ROUND</h1>
         <h1 className="mb-4">
